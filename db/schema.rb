...
ActiveRecord::Schema[8.1].define(version: 2026_04_23_000000) do
  create_table "aspace_repository_syncs", force: :cascade do |t|
    t.string "aspace_config_set", null: false
    t.datetime "last_synced_at", null: false
    t.string "repository_code", null: false
    t.index ["aspace_config_set", "repository_code"], name: "index_aspace_repository_syncs_on_config_set_and_code", unique: true
  end
