...
each_record do |_record, context|
  ...
  # Generate + write the semantic-search embedding vector for the collection
  # document, gated by ENABLE_SEMANTIC_INDEXING (default off). When off, no API
  # call is made and indexing behavior is identical to current behavior.
  SemanticSearch::Indexer.add_embedding!(context.output_hash) if SemanticSearch.indexing_enabled?
end
