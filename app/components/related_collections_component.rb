...
#
# Renders only when there is something to show, so a record with no stored
# vector (indexed with no API key, or before embedding_vector was populated)
# simply shows no panel.
#
